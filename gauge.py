...
#fonts
font = ImageFont.truetype("./arial.tff", layout_engine=ImageFont.LAYOUT_BASIC, 42)
font2 = ImageFont.truetype("./arial.tff", layout_engine=ImageFont.LAYOUT_BASIC, 20)
font3 = ImageFont.truetype("./arial.tff", layout_engine=ImageFont.LAYOUT_BASIC, 12)
gfont = ImageFont.truetype("./arial.tff", layout_engine=ImageFont.LAYOUT_BASIC, 54)
